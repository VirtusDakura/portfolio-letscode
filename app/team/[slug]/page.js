        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <AnimateOnScroll>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link href="/#team" className="btn py-4 px-8 text-base bg-transparent border border-[var(--color-border)] text-[var(--color-heading)] hover:border-[var(--color-border-hover)] hover:bg-[var(--color-bg-card)] transition-colors rounded-xl">
                Explore The Team
              </Link>
            </div>
          </AnimateOnScroll>
